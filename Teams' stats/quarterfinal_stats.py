...
path = "/Users/cyriltso/Documents/UCL Statistics/Teams' stats/Quarter Final"

url = 'https://footystats.org/europe/uefa-champions-league/2016-2017/overview'
browser.get(url)

table = browser.find_element_by_xpath('//*[@id="content"]/div[3]/div[3]/div/div[7]/div[1]/table')
...
db.to_csv(os.path.join(path, r'2016-2017 UCL Teams Quarter Final stats.csv'), index = False)