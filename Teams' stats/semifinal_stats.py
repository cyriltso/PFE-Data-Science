...
table = browser.find_element_by_xpath('//*[@id="content"]/div[3]/div[3]/div/div[6]/div[1]/table')
...
db.to_csv(os.path.join(path, r'2016-2017 UCL Teams Semi Final stats.csv'), index = False)